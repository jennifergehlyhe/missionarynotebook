...
<html lang="en">
<head>
  <title>Missionary Notebook</title>
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
   ...
   <div class="collapse navbar-collapse" id="myNavbar">
     ...
     <li><a href="shop-policies.php">SHOP FACTS</a></li>
      ...
      <li><a href="page-not-found.php" class="fa fa-facebook"></a></li>
...
<header>
  <div class="container-fluid text-center">
    <img src="mnlogo.png" class="img-responsive" style="display:inline" alt="logo" width="600" height="200">
  </div>
</header>
  <hr/>